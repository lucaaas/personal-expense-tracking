...
import 'package:personal_expense_tracker/app/pages/login_page/login_page.dart';
    ...
    switch (settings.name) {
      ...
      case AppRoutes.TRANSACTION_FORM:
        return CupertinoPageRoute(
          builder: (_) => TransactionFormPage(transaction: settings.arguments as TransactionModel?),
        );
